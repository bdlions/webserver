...
define('ADMIN_LOGIN_SUCCESS_VIEW', 'admin/index');
...
define('AGENT_LOGIN_SUCCESS_URI', 'auth');
define('AGENT_LOGIN_SUCCESS_TEMPLATE', 'agent/templates/main');
define('AGENT_LOGIN_SUCCESS_VIEW', 'agent/index');

define('SUBAGENT_LOGIN_SUCCESS_URI', 'auth');
define('SUBAGENT_LOGIN_SUCCESS_TEMPLATE', 'subagent/templates/main');
define('SUBAGENT_LOGIN_SUCCESS_VIEW', 'subagent/index');
