<script>
    $(function() {
        $("#agent_list_credit_transfer").change(function() {
            var user_id = $('#agent_list_credit_transfer').val();
            if(user_id > 0)
            {
            ...
            <div class="box-content">
                <div class="row form-group">
                    <div class="col-md-offset-1 col-md-3 pull-left">
                        <label>
                            <?php echo form_dropdown('subagent_list_credit_transfer', array('' => 'Select agent')+$subagent_list, '', 'class=form-control id=subagent_list_credit_transfer'); ?>
                        </label>
                    </div>
                    <div class="col-md-3">
                        <label>
                                <select id="agent_list_credit_transfer" name="agent_list_credit_transfer" class="form-control form_control_custom">
